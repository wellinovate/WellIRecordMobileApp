...
export function Logo({
  ...
  const rColor = recordColor || color;
  ...
  return (
    <Svg width={width} height={height} viewBox="0 0 170 34" fill="none">
      ...
      {/* R */}
      <Path d="M86 9 H92 C94.8 9 96.5 10.5 96.5 12.8 C96.5 14.5 95.4 15.8 93.8 16.3 L97 24 H93.8 L91 17.2 H88.8 V24 H86 Z M88.8 14.9 H91.6 C92.9 14.9 93.7 14.1 93.7 12.9 C93.7 11.7 92.9 11.1 91.6 11.1 H88.8 Z" fill={rColor} />
      {/* e */}
      <Path d="M102.5 13.5 C99.5 13.5 97.5 15.6 97.5 18.8 C97.5 22 99.5 24.2 102.8 24.2 C104.8 24.2 106.3 23.3 107.1 21.8 L104.8 20.8 C104.3 21.6 103.5 22 102.7 22 C101.2 22 100.2 21 100.1 19.6 H107.5 C107.6 19.3 107.6 19 107.6 18.6 C107.6 15.5 105.6 13.5 102.5 13.5 Z M100.1 17.6 C100.4 16.3 101.3 15.4 102.5 15.4 C103.7 15.4 104.6 16.3 104.9 17.6 Z" fill={rColor} />
      {/* c */}
      <Path d="M114.5 13.5 C111.4 13.5 109.4 15.7 109.4 18.9 C109.4 22.1 111.4 24.3 114.6 24.3 C116.6 24.3 118.2 23.3 119 21.8 L116.7 20.6 C116.2 21.5 115.4 22 114.5 22 C113.1 22 112.1 20.9 112.1 18.9 C112.1 16.9 113.1 15.8 114.5 15.8 C115.4 15.8 116.2 16.3 116.7 17.2 L119 16 C118.2 14.5 116.6 13.5 114.5 13.5 Z" fill={rColor} />
      {/* o */}
      <Path d="M125.5 13.5 C122.3 13.5 120.2 15.7 120.2 18.9 C120.2 22.1 122.3 24.3 125.5 24.3 C128.7 24.3 130.8 22.1 130.8 18.9 C130.8 15.7 128.7 13.5 125.5 13.5 Z M125.5 22 C123.8 22 122.8 20.7 122.8 18.9 C122.8 17.1 123.8 15.8 125.5 15.8 C127.2 15.8 128.2 17.1 128.2 18.9 C128.2 20.7 127.2 22 125.5 22 Z" fill={rColor} />
      {/* r */}
      <Path d="M133.5 13.8 H136.1 V15.8 C136.8 14.4 138.1 13.6 139.7 13.6 L139.5 16.2 C137.6 16.2 136.2 17.4 136.2 19.5 V24 H133.5 Z" fill={rColor} />
      {/* d */}
      <Path d="M147 7.5 H149.7 V24 H147.2 V22.1 C146.4 23.5 144.9 24.3 143.1 24.3 C140 24.3 137.9 22.1 137.9 18.9 C137.9 15.7 140 13.5 143.1 13.5 C144.9 13.5 146.4 14.3 147.2 15.7 V7.5 Z M143.8 22 C145.5 22 147 20.7 147 18.9 C147 17.1 145.5 15.8 143.8 15.8 C142.1 15.8 140.6 17.1 140.6 18.9 C140.6 20.7 142.1 22 143.8 22 Z" fill={rColor} />
    </Svg>
  );
}
