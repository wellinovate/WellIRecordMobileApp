  ...
  return (
    <div style={{ position: 'absolute', inset: 0, background: '#0f172a', zIndex: 45, paddingTop: 54, display: 'flex', flexDirection: 'column' }}>
      <div style={{ flex: 1, position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(160deg,#0B1F3A,#0E5E6F)' }}>
        ...
        <div style={{ position: 'absolute', top: 40, left: 18, color: '#cbd5e1', fontSize: 11.5 }}>02:14</div>
        <div
          style={{
            position: 'absolute',
            bottom: 18,
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 20, padding: '22px 20px 30px' }}>
        <div style={{ width: 52, height: 52, borderRadius: 999, background: 'rgba(255,255,255,.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' }}>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
            <path d="M12 16a3 3 0 003-3V6a3 3 0 10-6 0v7a3 3 0 003 3z" stroke="#fff" strokeWidth="1.6" />
            <path d="M6 11v1a6 6 0 0012 0v-1M12 18v3" stroke="#fff" strokeWidth="1.6" />
          </svg>
        </div>
        <div style={{ width: 52, height: 52, borderRadius: 999, background: 'rgba(255,255,255,.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' }}>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
            <rect x="3" y="6" width="13" height="12" rx="2" stroke="#fff" strokeWidth="1.6" />
            <path d="M16 10.5l5-3v9l-5-3" stroke="#fff" strokeWidth="1.6" fill="none" />
          </svg>
        </div>
        <div
